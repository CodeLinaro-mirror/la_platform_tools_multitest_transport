...
describe('TestRunDetail', () => {
  ...
  beforeEach(() => {
    ...
    //  'Observable<DeviceInfo[]>' is not assignable to parameter of type
  ...
  it('shows the execute test run action button when there are manual actions',
     () => {
       ...
       //  id: string; name: string; phases: TestRunPhase.MANUAL[]; }[]>' is not
       //  assignable to parameter of type 'Observable<TestRunAction[]>'.
       testRunActionClient.list.and.returnValue(observableOf(
  ...
  it('opens the test run action picker dialog and executes successfully',
     inject([MatDialog], (dialog: MatDialog) => {
       ...
       // error suppression.
       //  @ts-ignore(go/unfork-jasmine-typings): Argument of type '{
       //  componentInstance: { confirm: Observable<{ action_id: string; }[]>;
       //  }; }' is not assignable to parameter of type 'MatDialogRef<unknown,
       //  unknown>'.
