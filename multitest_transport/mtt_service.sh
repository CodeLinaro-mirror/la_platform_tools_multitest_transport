...
export MTT_CONFIG_SERVICE_STORAGE_TYPE="${MTT_CONFIG_SERVICE_STORAGE_TYPE:-LOCAL_FILE}"
export MTT_CONFIG_SERVICE_LOCAL_STORAGE_DIR="${MTT_CONFIG_SERVICE_LOCAL_STORAGE_DIR:-/data/config_service}"
...
export MTT_ENABLE_LAB_CONSOLE_UI="${MTT_ENABLE_LAB_CONSOLE_UI:-}"
