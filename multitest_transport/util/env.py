...
LABCONSOLE_SERVER_GRPC_PORT = os.environ.get(
    'LABCONSOLE_SERVER_GRPC_PORT', '8080'
)
LABCONSOLE_SERVER_REST_PORT = os.environ.get(
...
REPORT_GENERATOR_JAR = os.environ.get('MTT_REPORT_GENERATOR_JAR', UNKNOWN)
